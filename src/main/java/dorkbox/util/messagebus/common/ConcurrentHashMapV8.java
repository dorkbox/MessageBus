...
public class ConcurrentHashMapV8<K, V> extends ConcurrentHashMap<K, V>
    implements ConcurrentMap<K,V>, Serializable {
    public ConcurrentHashMapV8(int i, float loadFactor, int stripeSize) {
        super(i, loadFactor, stripeSize);
    }
...
//     * {@code removeAll}, {@code retainAll}, and {@code shutdown}
...
//     * {@code retainAll}, and {@code shutdown} operations.  It does not
...
//         */
//        @Override
//        public final void shutdown()      { this.map.shutdown(); }
//        @Override
