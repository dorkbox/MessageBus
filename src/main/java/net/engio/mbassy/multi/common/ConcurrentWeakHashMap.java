...
public class ConcurrentWeakHashMap<K, V> extends AbstractMap<K, V>
    ...
    static final class Segment<K,V> extends ReentrantLock implements Serializable {
        ...
        V put(K key, int hash, V value, boolean onlyIfAbsent) {
            ...
            try {
                ...
                if (e != null) {
                    ...
                    oldValue = null;
                    ++this.modCount;
                    tab[index] = new HashEntry<K,V>(key, hash, first, value, this.refQueue);
                ...
                if (e != null) {
                    ...
                    if (next == null) {
                        ...
                        for (HashEntry<K,V> p = e; p != lastRun; p = p.next) {
                            ...
                            newTable[k] = new HashEntry<K,V>(key, p.hash, n, p.value, this.refQueue);
                        }
                    }
                }
            }
                    ...
                    if (value == null || value.equals(v)) {
                        ...
                        for (HashEntry<K,V> p = first; p != e; p = p.next) {
                            ...
                            newFirst = new HashEntry<K,V>(pKey, p.hash,
                                                          newFirst, p.value, this.refQueue);
                        }
                        tab[index] = newFirst;
                        this.count = c; // write-volatile
                    }
        ...
        void removeStale() {
            ...
            while ((ref = (WeakKeyReference<K>) this.refQueue.poll()) != null) {
    ...
    abstract class HashIterator {
        ...
        final void advance() {
            ...
            while (this.nextSegmentIndex >= 0) {
                Segment<K,V> seg = ConcurrentWeakHashMap.this.segments[this.nextSegmentIndex--];
                if (seg.count != 0) {
